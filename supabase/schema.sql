...
CREATE TABLE IF NOT EXISTS orders (
    ...
    payment_method VARCHAR(50) NOT NULL CONSTRAINT check_order_payment_method CHECK (payment_method IN ('cash', 'qris', 'bank_transfer')),
...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    payment_method VARCHAR(50) NOT NULL CONSTRAINT check_transaction_payment_method CHECK (payment_method IN ('cash', 'qris', 'bank_transfer')),
